import { createpost, selectpost, deletepost, selectById, updatepost,addComment, addLike, addUnLike } from "../controller/postController";
...
postRoutes.post("/unlike/:id", Authorization,fileUpload.single("postImage"), addUnLike);
